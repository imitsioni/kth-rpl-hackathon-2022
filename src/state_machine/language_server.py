...
class LanguageServer:
	...
	def ask_for_start_grasping(self):
		while True:
			...
			if recognized_str in self.available_answers:
				...
				self.playsound(self.voice_path + '/' + 'did_not_understand_answer.mp3')
	...
	def ask_for_close_gripper(self):
		while True:
			...
			self.playsound(self.voice_path + '/' + 'should_I_close_gripper.mp3')
			...
			if recognized_str in self.available_answers:
				if recognized_str == 'no' or recognized_str == 'open':
					...
					self.playsound(self.voice_path + '/' + 'opening_gripper.mp3')
